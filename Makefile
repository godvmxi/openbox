...
LT_RELEASE = 3.4
LT_REVISION = 9
MAKEINFO = ${SHELL} /root/dev/openbox-3.4.11.2/missing --run makeinfo
...
install_sh = /root/dev/openbox-3.4.11.2/install-sh
libdir = /usr/lib
